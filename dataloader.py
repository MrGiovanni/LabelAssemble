...
class CXR3(Dataset):
    def __init__(self, pathImageRoot, pathDatasetRoot, augment, num_class=16, mode='train'):
        ...
        with open(pathDatasetFile, "r") as fileDescriptor:
            ...
            while line:
                ...
                if line:
                    ...
                    if imageLabel[6]:
                        self.img_list.append(imagePath)
                        self.img_label.append([0, 0, 1])
                    else:
                        self.img_list.append(imagePath)
                        self.img_label.append([1, 0, 0])
...
class Assemble(Dataset):
    def __init__(self, pathImageRoots, pathDatasetRoots, augment, num_class=16, mode='train', ratio=1):
        ...
        cxr3 = CXR3(pathImageRoots[0], pathDatasetRoots[0], augment, mode=mode)
